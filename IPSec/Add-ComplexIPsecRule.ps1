...
(Note: MM rules are sometimes called "IKE rules" and QM rules are sometimes 
called "IPsec rules.")
...
$MmCryptoSetAllowDH = New-NetIPsecMainModeCryptoSet -DisplayName 'MMCryptoSetAllowDH' -ForceDiffieHellman $False -Proposal @($MmAes256Sha384Dh24,$MmAes128Sha256Dh19) 
...
$IPsec2 = New-NetIPsecRule -DisplayName "IPsec2" -InboundSecurity Require -OutboundSecurity Request -KeyModule IKEv2 -InterfaceType Wireless  
